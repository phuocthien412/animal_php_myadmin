...
*   **Tệp cấu hình ngôn ngữ (Từ điển)**:
    *   [vi.php](../config/lang/vi.php) - Bổ sung các cụm từ Tiếng Việt.
    *   [en.php](../config/lang/en.php) - Bổ sung các cụm từ Tiếng Anh tương ứng.
*   **Các View phía Client (Giao diện người dùng)**:
    *   [FindAnimal.php](../view/home/FindAnimal.php) - Trang Nhận Diện Động Vật bằng AI.
    *   [posts-list.php](../view/post/posts-list.php) - Trang Cộng Đồng Bài Viết.
*   **Các View phía Admin (Bảng quản trị)**:
    *   [animal-admin.php](../view/admin/animals/animal-admin.php) - Trang Quản lý Động vật.
    *   [comment-admin.php](../view/admin/comments/comment-admin.php) - Trang Quản lý Bình luận.
    *   [notification-list.php](../view/admin/notifications/notification-list.php) - Trang Trung tâm Thông báo.
